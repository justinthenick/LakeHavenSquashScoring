...
function sbGet_(table,query){
 var keys={player_aliases:'alias_id',comps:'comp_ref',players:'player_id',teams:'team_id',roster:'roster_id',roster_substitutes:'player_id',fixtures:'fixture_id',match_log:'match_id',game_log:'game_pk',rally_log:'rally_pk',player_arrivals:'id'};
